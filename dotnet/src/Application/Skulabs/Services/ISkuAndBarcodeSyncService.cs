...
/// </summary>
public interface ISkuAndBarcodeSyncService
{
    /// <summary>
    ...
    /// </summary>
    Task<SkuAndBarcodeSyncResult> SyncAll(CancellationToken cancellationToken = default);
    ...
    Task<SkuAndBarcodeSyncResult> SyncForSkulabsItem(Guid skulabsItemId, CancellationToken cancellationToken = default);
}
