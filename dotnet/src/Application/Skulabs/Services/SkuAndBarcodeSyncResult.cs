...
/// <summary>
/// Outcome of a single <see cref="ISkuAndBarcodeSyncService"/> run.
/// </summary>
...
public readonly record struct SkuAndBarcodeSyncResult(
    int Checked,
    int Drifted,
    int Corrected,
    int Failed)
{
    public static SkuAndBarcodeSyncResult Empty => new(0, 0, 0, 0);
}
